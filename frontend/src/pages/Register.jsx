      ...
      <div className='min-h-screen flex items-center justify-center bg-gray-100'>
        <div className='w-full max-w-md bg-white shadow-md rounded-lg p-8'>
          <form onSubmit={handleRegister}>
            ...
            <p className='text-center mb-4'>Already Registered?{""} <Link className="text-blue-600">Login now</Link>
            </p>
            <button type='submit' className='w-full p-2 bg-blue-500 hover:bg-blue-800 duration-300 rounded-md'>Register</button>
          </form>
        </div>
      </div>
    </div>
