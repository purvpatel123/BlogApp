            ...
            className='bg-white rounded-lg hover:shadow-lg overflow-hidden transform
             hover:scale-105 transition-transform duration-300'>
              <div className='relative'>
                ...
                <h1 className='absolute bottom-4 left-4 text-white text-xl font-bold hover:text-yellow-500
                transition-colors duration-300'>{element.title}</h1>
              </div>
